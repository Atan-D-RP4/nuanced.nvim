...
local mini_utils = require('mini.statusline').utils
local my_utils = require 'nuance.statusline.miniline_utils'
...
local groups = {
  ...
  },
  {
    priority = 9,
    string = function()
      return numOfDiag { severity = 'WARN' }
    end,
    hl = 'DiagnosticWarn',
  },
  {
    priority = 8,
    string = function()
      return numOfDiag { severity = 'INFO' }
    end,
    hl = 'DiagnosticInfo',
  },
  {
    priority = 7,
    string = function()
      return numOfDiag { severity = 'HINT' }
    end,
    hl = 'DiagnosticHint',
  },
  align,
